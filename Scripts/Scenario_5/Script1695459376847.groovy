...
Mobile.setText(findTestObject('Object Repository/AddTodo/android.widget.EditText - Input Name'), Name, 0)

Mobile.comment('Select Date')

Mobile.setText(findTestObject('AddTodo/android.widget.SetCalendar'), Date, 0)
...
Mobile.tap(findTestObject('AddTodo/android.widget.TextView - Secondary'), Type)

Mobile.comment('Input description')

Mobile.setText(findTestObject('Object Repository/AddTodo/android.widget.EditText - Input Description'), Description, 0)
