...
Mobile.setText(findTestObject('Object Repository/AddTodo/android.widget.EditText - Input Name'), 'MST QA Test 2', 0)

Mobile.comment('Select Date')

Mobile.tap(findTestObject('Object Repository/AddTodo/android.view.IconCalendar'), 0)

Mobile.tap(findTestObject('AddTodo/android.widget.LeftMonthChevron'), 0)

Mobile.tap(findTestObject('AddTodo/android.widget.SelectDate3'), 0)
